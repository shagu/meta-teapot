##
# Teapot Image Class for beaglebone
...
IMAGE_TYPEDEP_sdcard-beaglebone = "${SDIMG_ROOTFS_TYPE}"

SDIMG_ROOTFS = "${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.rootfs.${SDIMG_ROOTFS_TYPE}"

IMAGE_DEPENDS_sdcard-beaglebone = " \
			parted-native \
			mtools-native \
			dosfstools-native \
			virtual/kernel \
...
IMAGE_CMD_sdcard-beaglebone () {
	...
	MTOOLS_SKIP_CHECK=1 mcopy -i ${WORKDIR}/boot.img -s ${DEPLOY_DIR_IMAGE}/zImage-am335x-boneblack.dtb ::/am335x-boneblack.dtb
